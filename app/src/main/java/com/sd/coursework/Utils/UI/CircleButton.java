...
/* Credits to: https://github.com/markushi/android-circlebutton */
...
public class CircleButton extends AppCompatImageView {
    ...
    private static final int ANIMATION_TIME_DEFAULT = 500;
    ...
    public int getDisabledColor() {
        int returnClr = orginalColor = defaultColor;

        returnClr = ColorUtils.blendARGB(defaultColor, Color.BLACK,0.2f);
        return returnClr;
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int animationTime = ANIMATION_TIME_DEFAULT;
        ...
        if (attrs != null) {
            ...
            animationTime = a.getInt(R.styleable.CircleButton_cb_animTime, animationTime);
            a.recycle();
        }
        ...
        pressedAnimator.setDuration(animationTime);
    }
